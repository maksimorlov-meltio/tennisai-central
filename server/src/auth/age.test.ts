// ============================================================================
// Unit tests — server-side age maths (src/auth/age.ts).
//
// The mirror of these cases lives at src/lib/__tests__/age.test.ts in the
// frontend package. When one changes, change the other: the browser copy shapes
// the sign-up form, this one decides whether a child needs a guardian.
// ============================================================================
