...
//
// A NEAR-IDENTICAL COPY LIVES AT src/lib/age.ts, which the sign-up form uses to
// decide whether to show the guardian fields. The two cannot share a module
// (separate packages, separate tsconfigs). THIS ONE IS AUTHORITATIVE: the
// browser copy only shapes the form, it never decides whether consent is
// required. Both are covered by matching tests.
// ============================================================================
